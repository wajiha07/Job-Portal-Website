...
<style>
  @media screen and (max-width: 1199px) {
    ...
    #from-landing-page.job-detail-header.v1 {
...
$jobdesk_ref_code = sanitize_text_field($_GET['jobdesk_ref_code']);
  ...
  <div class="job-detail-header v1 bg-white">
    <div class="container bg-white">
      <div class="row bg-white">
        <div class="col-md-12 text-center px-5 bg-white">
...
<?php } else {
  ...
  $applyJobFormFields = [];
  foreach (\Jobdesk\Classes\Database::getApplyJobFormEnabledFields() as $field) {
...
?>
  ...
  <!--  -->
  <div class="wr-job-class">
    <div class="job-detail-header v1" style="background:#F5F7FE; padding:70px 0">
      <div class="container">
        <div class="row flex-middle-sm">
          <div class="col-md-8 col-sm-7 col-xs-12">
            <div class="flex-middle-sm">
              <div class="employer-logo">
                <img width="100" height="100" src="<?php echo plugin_dir_url(dirname(dirname(__FILE__))) . 'assets/images/job-logo.png'; ?>" class="attachment-thumbnail size-thumbnail wp-post-image" alt="" style="">
              ...
              <div class="info-detail-job">
                ...
                <div class="job-metas-detail">
                  <div class="category-job">
                    <div class="job-category with-icon"  style="color:#66789C; ">
                      ...
                      <?php echo esc_html($_GET['job_type']); ?>
                    </div>
                  </div>
                  ...
                  <div class="job-deadline with-icon" style="color:#66789C;">
                  <i class="flaticon-wall-clock"></i> <?php echo date_i18n("d-m-Y", strtotime($res_de->GoogleJob->validThrough));  ?></div>
                ...
                <div class="job-metas-detail-bottom">
                  <div class="job-type with-title">
                    <!-- <a class="type-job" href="https://apusthemes.com/wp-demo/superio-new/job-type/full-time/" style="">Full Time</a> -->
                  </div>
          ...
          <div class="job-detail-buttons col-md-4 col-sm-5 col-xs-12">
            <div class="action">
              ...
              <!--<div class="deadline-time">Application ends: <strong><?php echo date_i18n("Y-m-d", strtotime($res_de->GoogleJob->validThrough));  ?></strong></div>-->
              ...
              ?>
                <li>
                  ...
                  <div class="details">
                    ...
                    <div class="value"><span class="suffix">$</span><span class="price-text" style="color:#66789C;"><?php echo $res_de->GoogleJob->baseSalary; ?></span> </div>
                  </div>
                </li>
              <?php
              }

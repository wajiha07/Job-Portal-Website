    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            $repeater->add_control(
                ...
                [
                    'label' => esc_html__( 'Alert Note', 'htmega-addons' ),
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'selectors' => [
                            ...
                            '{{WRAPPER}} .htmega-marker-style-6 .htmega-shadow-wrapper' => 'width: {{SIZE}}{{UNIT}};',
                        ],
                    ]
                );
                ...
                $this->add_responsive_control(
                    ...
                    [
                        ...
                        'selectors' => [
                            ...
                            '{{WRAPPER}} .htmega-marker-style-6 .htmega-shadow-wrapper' => 'height: {{SIZE}}{{UNIT}};',
                        ],
                    ]
                );

...
class WP_Job_Board_Pro_Wc_Paid_Listings_Template_Loader {
	 ...
	 * @throws Exception
	 */
	public static function locate( $name, $plugin_dir = WP_JOB_BOARD_PRO_WC_PAID_LISTINGS_PLUGIN_DIR ) {
		$template = '';
		...
		$theme_folder_name = apply_filters( 'wp-job-board-pro-wc-paid-listings-theme-folder-name', 'wp-job-board-pro-wc-paid-listings' );
		// Child theme
	 ...
	 * @throws Exception
	 */
	public static function get_template_part( $name, $args = array(), $plugin_dir = WP_JOB_BOARD_PRO_WC_PAID_LISTINGS_PLUGIN_DIR ) {

                        ...
                        <td align="center" valign="top"><!-- Header -->
                            <table id="template_header" border="0" width="100%" cellspacing="0" cellpadding="0">
                                <tbody>
                                    <tr>
                                        <td>
                                            <h1 id="logo" style="padding: 28px 24px; display: block; font-family: Arial; font-size: 30px; font-weight: bold; text-align: center; line-height: 150%;">Re-scheduled Meeting</h1>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td valign="top">Hello {{user_name}}
                                                            ...
                                                            The meeting is re-scheduled this job "{{job_title}}".

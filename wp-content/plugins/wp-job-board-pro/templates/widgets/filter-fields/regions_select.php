            ...
            ?>
                ...
                <div class="field-region field-region2">
                    <?php if ( !empty($field['icon']) ) { ?>
                        <i class="<?php echo esc_attr( $field['icon'] ); ?>"></i>
                    <?php } ?>
                    <select class="select-field-region select-field-region2 form-control" data-next="3" autocomplete="off" name="<?php echo esc_attr($name); ?>[]" data-placeholder="<?php echo esc_attr($placeholder2); ?>"  data-taxonomy="<?php echo esc_attr($taxonomy); ?>">
            ...
            ?>
                ...
                <div class="field-region field-region3">
                    <?php if ( !empty($field['icon']) ) { ?>
                        <i class="<?php echo esc_attr( $field['icon'] ); ?>"></i>
                    <?php } ?>
                    <select class="select-field-region select-field-region3 form-control" data-next="4" autocomplete="off" name="<?php echo esc_attr($name); ?>[]" data-placeholder="<?php echo esc_attr($placeholder3); ?>"  data-taxonomy="<?php echo esc_attr($taxonomy); ?>">
            ...
            ?>
                <div class="field-region field-region4">
                    <?php if ( !empty($field['icon']) ) { ?>
                        <i class="<?php echo esc_attr( $field['icon'] ); ?>"></i>
                    <?php } ?>
                    <select class="select-field-region select-field-region4 form-control" data-next="5" autocomplete="off" name="<?php echo esc_attr($name); ?>[]" data-placeholder="<?php echo esc_attr($placeholder4); ?>" data-taxonomy="<?php echo esc_attr($taxonomy); ?>">

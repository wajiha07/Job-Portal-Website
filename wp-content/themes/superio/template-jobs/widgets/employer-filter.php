...
<form method="get" action="<?php echo WP_Job_Board_Pro_Mixes::get_employers_page_url(); ?>" class="filter-employer-form filter-listing-form vertical filter-listing-form-wrapper">
